exports.READ_MASTER_DATA_ENTRY_ID_BY_NAME = "SELECT mde.MASTER_DATA_ENTRY_ID FROM MASTER_DATA_ENTRY mde WHERE LOWER(mde.NAME) = '{name}'";
exports.READ_CATEGORY_ID_BY_NAME = "SELECT cc.CONTENT_CATEGORY_ID FROM CONTENT_CATEGORY cc WHERE LOWER(cc.NAME) = '{name}'";
exports.READ_CONTENT_ID_BY_PATH = "select regexp_substr('{path}', '[^/]+$', 1, 1) FROM CONTENT_INFORMATION ci";
